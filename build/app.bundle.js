...
_reactDom2.default.render(_react2.default.createElement(_App2.default, null), document.getElementById('app')); // Task 4.4
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function changeInputValue(newVal) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            props.data.map(function (todo) {
                return _react2.default.createElement(_Todo2.default, { key: todo.id, id: todo.id, removeTodo: props.removeTodo, text: todo.text });
            })
        )
    );
}; // Task 4.7
